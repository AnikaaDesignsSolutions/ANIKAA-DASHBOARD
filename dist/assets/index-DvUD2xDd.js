import{cT as ur,h as $}from"./index-JPne9CEF.js";import{d as Mr}from"./a-m_gG6TNI.js";import"./layout-BCHN20rd.js";import"./use-notification-BHuC7VdR.js";import"./index-CGO0cPyz.js";import"./error-messages-DhbYeD1Z.js";import"./index.esm-duCv3Qe7.js";import"./index-B7WhEIZx.js";import"./index-qr1gExzI.js";var h={},X={};for(var vr=[],p=0;p<64;)vr[p]=0|4294967296*Math.sin(++p%Math.PI);function Wr(r){var a,e,t,n=[a=1732584193,e=4023233417,~a,~e],i=[],o=unescape(encodeURI(r))+"",l=o.length;for(r=--l/4+2|15,i[--r]=8*l;~l;)i[l>>2]|=o.charCodeAt(l)<<8*l--;for(p=o=0;p<r;p+=16){for(l=n;o<64;l=[t=l[3],a+((t=l[0]+[a&e|~a&t,t&a|~t&e,a^e^t,e^(a|~t)][l=o>>4]+vr[o]+~~i[p|15&[o,5*o+1,3*o+5,7*o][l]])<<(l=[7,12,17,22,5,9,14,20,4,11,16,23,6,10,15,21][4*l+o++%4])|t>>>-l),a,e])a=0|l[1],e=l[2];for(o=4;o;)n[--o]+=l[o]}for(r="";o<32;)r+=(n[o>>3]>>4*(1^o++)&15).toString(16);return r}const Hr=Object.freeze(Object.defineProperty({__proto__:null,default:Wr},Symbol.toStringTag,{value:"Module"})),Gr=ur(Hr);var sr={exports:{}};(function(r,a){(function(e,t){r.exports=function(n,i,o,l,f){for(i=i.split?i.split("."):i,l=0;l<i.length;l++)n=n?n[i[l]]:f;return n===f?o:n}})()})(sr);var B=sr.exports;/**
* @license Apache-2.0
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var ha=$a,da=ya,ga=Aa,T;ha()?T=da:T=ga;var Sa=T;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var ja=Object.prototype.toString,mr=ja;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var Ra=mr;function Ca(r){return Ra.call(r)}var Da=Ca;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var Ka=Ja,b=za,w=mr;function Qa(r){var a,e,t;if(r==null)return w.call(r);e=r[b],a=Ka(r,b);try{r[b]=void 0}catch{return w.call(r)}return t=w.call(r),a?r[b]=e:delete r[b],t}var Ya=Qa;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var se=oe,O=fe,k=ve;function ce(){var r,a;if(typeof k!="function")return!1;try{a=[1,3.14,-3.14,O+1,O+2],a=new k(a),r=se(a)&&a[0]===1&&a[1]===3&&a[2]===O-2&&a[3]===0&&a[4]===1}catch{r=!1}return r}var $e=ce;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var he=ye,de=be,ge=Ae,L;he()?L=de:L=ge;var V=L;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var ft=tt,ut=it,vt=lt,W;ft()?W=ut:W=vt;var st=W;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var gt=bt,I=At,er=dt;function St(){var r,a;if(typeof er!="function")return!1;try{a=[1,3.14,-3.14,I+1,I+2],a=new er(a),r=gt(a)&&a[0]===1&&a[1]===3&&a[2]===I-2&&a[3]===0&&a[4]===1}catch{r=!1}return r}var wt=St;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var tr=jt,Ar;function Rt(){var r,a;return r=new tr.uint16(1),r[0]=4660,a=new tr.uint8(r.buffer),a[0]===52}Ar=Rt();var Ct=Ar;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var Xt=J,hr,G,j;Xt===!0?(G=1,j=0):(G=0,j=1);hr={HIGH:G,LOW:j};var Bt=hr;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var Vt=V,xt=x,dr=Bt,gr=new xt(1),nr=new Vt(gr.buffer),Jt=dr.HIGH,qt=dr.LOW;function zt(r,a,e,t){return gr[0]=r,a[t]=nr[Jt],a[t+e]=nr[qt],a}var Sr=zt;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var en=V,tn=x,nn=an,Nr=new tn(1),on=new en(Nr.buffer);function ln(r){return Nr[0]=r,on[nn]}var fn=ln;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var An=oa,hn=fa,dn=Or,gn=Ir,Sn=Tr,U=[0,0];function wn(r,a){var e,t;return dn.assign(r,U,1,0),e=U[0],e&=hn,t=gn(a),t&=An,e|=t,Sn(e,U[1])}var On=wn;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var ai=cr,ei=$r,ti=pr,ni=Jr,ii=zr,oi=Qr,li=yr,fi=_r,ui=In,vi=xn,si=ri,ci=Or,$i=Tr,pi=2220446049250313e-31,yi=2148532223,E=[0,0],P=[0,0];function _i(r,a){var e,t;return r===0||li(r)||fi(r)?r:(vi(E),r=E[0],a+=E[1],a+=si(r),a<oi?ui(0,r):a>ni?r<0?ei:ai:(a<=ii?(a+=52,t=pi):t=1,ci(P),e=P[0],e&=yi,e|=a+ti<<20,t*$i(e,P[1])))}var bi=_i;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
